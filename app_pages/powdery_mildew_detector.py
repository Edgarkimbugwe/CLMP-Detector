...
def powdery_mildew_detector_body():
    ...
    st.info(
        "Upload images of cherry leaves to determine if they are affected by "
        "powdery mildew, and download a report of the analysis."
    )
    ...
    st.markdown(
        ...
        <div style="text-align: center;">
            <ul style="list-style-type: disc; padding-left: 0; display: inline-block;">
                <li>You can download a set of infected and healthy leaves for live "
                "prediction from <a href=\"https://www.kaggle.com/datasets/codeinstitute/cherry-leaves\" target=\"_blank\">"
                "here</a>.</li>
            </ul>
        </div>
        """,
    ...
    st.write(
        "**Upload a clear image of a cherry leaf. Multiple selections are allowed.**"
    )
    images_buffer = st.file_uploader(' ', type=['png', 'jpg'],
    ...
    if images_buffer is not None:
        ...
        for image in images_buffer:
            ...
            st.image(img_pil, caption=f"Image Size: {img_array.shape[1]}px width "
